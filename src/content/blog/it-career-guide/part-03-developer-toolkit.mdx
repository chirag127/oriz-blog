...
graph TD
    ...
    LoginCheck -->|Yes (e.g. SSH, bash -l)| ReadGlobalProfile["Read /etc/profile"]
    ...
    LoginCheck -->|No (e.g. New WSL Tab)| ReadGlobalBashrc["Read /etc/bash.bashrc"]
