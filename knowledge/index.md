---
type: index
title: "oriz-pages-blog-app — knowledge bundle"
description: "App-specific knowledge for oriz-pages-blog-app. Cross-cutting family rules live at master `c:/D/oriz/knowledge/`."
tags: [okf, index, app, pages-blog]
timestamp: 2026-06-21
format_version: okf-v0.1
status: active
---

# oriz-pages-blog-app — knowledge bundle

This is the per-app OKF-light bundle for **oriz-pages-blog-app**. App-specific facts only. Cross-cutting family rules / decisions / services live at master [`../../../../knowledge/`](../../../../knowledge/).
...
- **Category**: content
- **Family role**: Long-form writing on engineering, finance, and books — the blog at blog.oriz.in.
